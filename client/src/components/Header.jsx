...
export default function Header() {
  ...
  const cartCount = useMemo(
    () => (Array.isArray(cart) ? cart.reduce((acc, item) => acc + Number(item.quantity || 1), 0) : 0),
    [cart]
  );
                    ...
                    return (
                      <div
                        ...
                        className={`px-4 py-2 cursor-pointer transition-all ${
                          isHighlighted || isActive ? "bg-gray-100" : "hover:bg-gray-50"
          ...
          {!user ? (
            <>
              <motion.div whileHover={{ scale: 1.05 }}>
                <Link to="/login" className="text-gray-600 hover:text-red-500 transition font-medium">
                  Login
                </Link>
              </motion.div>

              <motion.div whileHover={{ scale: 1.05 }}>
                <Link to="/register" className="text-gray-600 hover:text-red-500 transition font-medium">
                  Register
                </Link>
              </motion.div>
            ...
            <>
              ...
              <motion.div whileHover={{ scale: 1.05 }}>
                <Link to="/my-orders" className="text-gray-600 hover:text-red-500 transition font-medium">
                  My Orders
                </Link>
              </motion.div>
