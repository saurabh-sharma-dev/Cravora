  ...
  return (
    ...
    >
      ...
      <div className="absolute top-3 left-3 z-10 flex items-center gap-2">
        ...
        {item?.spicyLevel && (
          <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-semibold border ${spicyBadge}`}>
      ...
      <div className="relative h-48 overflow-hidden">
        ...
        <motion.button
          ...
          className={`hidden md:flex absolute bottom-3 right-3 z-10 items-center gap-2 px-4 py-2 rounded-full font-semibold shadow-lg transition
            ${canAdd ? "bg-gradient-to-r from-red-500 to-pink-500 text-white hover:opacity-90" : "bg-gray-300 text-gray-500 cursor-not-allowed"}`}
      ...
      <div className="p-4 flex flex-col gap-2 flex-1">
        ...
        <div className="mt-2 flex items-center justify-between">
          ...
          {/* Primary Add CTA (always visible) */}
          <motion.button
            onClick={handleAddToCart}
            disabled={!canAdd}
