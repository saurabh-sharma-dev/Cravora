...
export default function ReviewForm({ restaurantId, onAdded }) {
  ...
  const submit = async (e) => {
    ...
    setLoading(true);
    try {
      const review = await addReview(restaurantId, { rating, comment: comment.trim() || undefined });
      setMsg("✅ Review added!");
      setRating(0);
      setComment("");
      onAdded?.(review);
      ...
      setMsg(apiMsg || "❌ Failed to add review");
    } finally {
      setLoading(false);
    }
  };
  ...
  const isSuccess = msg && msg.startsWith("✅");
        ...
        {msg && (
          ...
          >
            ...
            <span className="leading-snug">
              {msg === "You have already reviewed this restaurant"
