                  ...
                  {alerts.map((a) => (
                    <motion.div
                      ...
                      className={`rounded-lg border p-3 ${
                        a.type === "success" ? "border-green-200" : a.type === "error" ? "border-red-200" : "border-gray-200"
                      }`}
                    >
                ...
                {[
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-sm transition ${
                      activeManageTab === t.key ? "bg-white shadow font-semibold" : "text-gray-600 hover:text-gray-800"
                    }`}
                  >
                    {t.label}
                  </button>
