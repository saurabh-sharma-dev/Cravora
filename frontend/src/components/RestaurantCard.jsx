...
// Framer Motion wrapper for React Router Link
  ...
  return (
    ...
    >
      ...
      <div className="p-4 flex flex-col gap-2">
        ...
        {/* Address */}
        {restaurant?.address && (
          <p className="text-xs text-gray-500 mt-1 truncate" title={restaurant.address}>
            📍 {restaurant.address}
          </p>
        )}
        ...
        {restaurantId ? (
          ...
          >
            <span className="absolute inset-0 bg-white/20 blur-md opacity-0 group-hover:opacity-30 transition-all duration-500" />
