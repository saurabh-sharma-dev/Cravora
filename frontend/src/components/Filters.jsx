...
import { Star, Clock, Leaf, TrendingUp, ArrowUpDown, Filter as FilterIcon } from "lucide-react";
    ...
    <div className="w-full flex flex-col gap-4">
      ...
      >
        ...
        <div className="flex items-center gap-2 text-lg font-bold text-gray-700">
          <FilterIcon size={22} className="text-red-500 animate-pulse" />
          Filters
        </div>
      ...
      <div className="flex flex-wrap gap-2 px-4">
        <AnimatePresence>
          ...
          {Number.isFinite(Number(maxDeliveryTime)) && Number(maxDeliveryTime) > 0 && (
            <motion.span
              layout
